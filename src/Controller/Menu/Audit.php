...
final class Audit extends AbstractFOSRestController
{
    ...
    public function __construct(MenuService $service, AuditService $audit, AuditReader $reader)
    {
     ...
     *         type="array",
     *         @SWG\Items(
     *             @SWG\Property(type="object", property="entity", ref=@Model(type=Menu::class, groups={"read"})),
    ...
    public function __invoke(Request $request, string $id): View
    {
        ...
        if (!$this->reader->getConfiguration()->isAuditable(Menu::class)) {
            return $this->view([]);
        }
