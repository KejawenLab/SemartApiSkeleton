...
{
    public function __construct(private readonly UserService $service, private readonly SerializerInterface $serializer)
    {
    }

    #[Route(path: '/users/download', name: self::class, methods: ['GET'])]
