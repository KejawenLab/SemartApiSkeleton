...
final class GetAll extends AbstractFOSRestController
{
    ...
    #[Parameter(name: 'username', in: 'query', new OA\Schema(type: 'string'))]
    #[Response(response: 200, description: 'User list', content: [new OA\MediaType(mediaType: 'application/json', new OA\Schema(type: 'array', new OA\Items(ref: new Model(type: User::class, groups: ['read']))))])]
